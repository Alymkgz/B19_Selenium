...
public class SoftAssertShowCase {
    ...
    @Test
    public void check(){
        Assert.assertEquals(sum(1,2), 3);//Hard Assert
    ...
    public void softAssertTest(){
        ...
        softAssert.assertEquals(sum(5,5),11);
        System.out.println("Code is working fine , it supposed to be fail, but it will continue");

        softAssert.assertAll("All failures are above"); // must have it so that you know where it failed during the test
    }
}
